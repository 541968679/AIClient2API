...
const translations = {
    'zh-CN': {
        ...
        // Proxies
        'proxies.title': '代理管理',
        'proxies.subtitle': '管理可分配给 Provider 节点的 HTTP/SOCKS 代理和订阅转换节点。',
        'proxies.total': '代理总数',
        'proxies.poolEnabled': '池中代理',
        'proxies.assigned': '已绑定节点',
        'proxies.subscriptionNodes': '订阅节点',
        'proxies.import': '批量导入',
        'proxies.importSubscription': '导入订阅',
        'proxies.add': '添加代理',
        'proxies.edit': '编辑代理',
        'proxies.search': '搜索名称、地址、标签...',
        'proxies.autoAssign': '自动分配未绑定节点',
        'proxies.autoAssignTitle': '为当前 Provider 类型的未绑定节点分配代理',
        'proxies.singBox': '生成 sing-box 配置',
        'proxies.name': '名称',
        'proxies.protocol': '协议',
        'proxies.address': '地址',
        'proxies.status': '状态',
        ...
        'proxies.outPool': '不入池',
        'proxies.url': '代理 URL',
        'proxies.keyword': '筛选关键词',
        'proxies.startPort': '起始端口',
        'proxies.importJsonFile': '从 JSON 文件导入',
        'proxies.importJsonHint': '支持 sub2api 导出的 JSON、A2 的 configs/proxies.json、纯代理数组；也可以直接粘贴 JSON 内容。',
        'proxies.importPlaceholder': '每行一个代理，支持 http://、https://、socks5://、host:port、host:port:user:pass；也支持粘贴 JSON',
        'proxies.subscriptionPlaceholder': '粘贴订阅地址、订阅内容或已解码节点列表；VLESS 节点会转换成 http://a2-proxy:端口',
        'proxies.emptyImport': '请输入代理内容',
        'proxies.importResult': '导入完成：创建 {created}，复用 {reused}，失败 {failed}',
        'proxies.saved': '代理已保存',
        'proxies.deleted': '代理已删除',
        'proxies.deleteConfirm': '确定删除该代理吗？已绑定节点会被解绑。',
        'proxies.test': '测试代理',
        'proxies.testOk': '代理可用',
        'proxies.testFailed': '代理测试失败',
        'proxies.autoAssignConfirm': '确定为 {type} 的所有未绑定节点自动分配代理吗？',
        'proxies.autoAssignResult': '自动分配完成：成功 {assigned}，跳过 {skipped}，无可用代理 {noProxy}',
        'modal.provider.proxy': '代理',
        'modal.provider.noProxy': '不使用节点代理',
        'modal.provider.autoAssignProxy': '自动分配代理',
        ...
        'oauth.kiro.batchImportInstructions': '请输入 refreshToken（每行一个），或粘贴/导入 JSON，系统会自动提取其中所有 refreshToken 字段。',
        ...
        'oauth.kiro.refreshTokensLabel': 'RefreshToken 列表或 JSON',
        'oauth.kiro.refreshTokensPlaceholder': '每行输入一个 refreshToken，或粘贴任意 JSON（会自动提取 refreshToken 字段）\n例如:\naorAxxxxxxxx\naorAyyyyyyyy',
        'oauth.kiro.importJsonFile': '导入 JSON 文件',
        'oauth.kiro.jsonParseError': 'JSON 格式错误，无法提取 refreshToken',
        'oauth.kiro.fileReadError': '读取 JSON 文件失败',
        ...
        'oauth.codex.tokensLabel': 'Token 数据 (JSON/Refresh Token)',
        'oauth.codex.tokensPlaceholder': '请粘贴 refresh_token-only JSON、完整 Token JSON，或逐行 refresh token...',
        'oauth.codex.importInstructions': '请粘贴 Codex refresh_token-only JSON 或完整 Token JSON。支持单个对象、对象数组、字符串数组或逐行 refresh token。',
        ...
        'oauth.codex.jsonHint': '请确保 JSON 包含 refresh_token，或同时包含 access_token 和 id_token',
        ...
        'config.advanced.rateLimitCooldownNote': '上游返回 429 时，让当前账号短暂退出账号池，到期后先检测，通过后自动恢复。',
        ...
        'config.proxy.proxiesFilePath': '代理池配置文件路径',
        'config.proxy.autoAssignOnImport': '导入账号时自动分配代理',
        ...
        'modal.provider.actions.account': '账号',
        'modal.provider.actions.proxyName': '代理/名称',
        'modal.provider.actions.health': '健康',
        'modal.provider.actions.exportCleanup': '导出/清理',
        'modal.provider.resetHealth': '重置为健康',
        'modal.provider.resetHealthTitle': '将所有账号从异常状态恢复为正常，并清空错误计数',
        'modal.provider.resetSingleHealthTitle': '将当前账号恢复为正常，并清空错误计数和冷却时间',
        'modal.provider.healthCheck': '检测不健康',
        'modal.provider.healthCheckAll': '检测全部',
        'modal.provider.healthCheckAllTitle': '检测所有未禁用账号，429 会标记为不健康并进入冷却',
        'modal.provider.healthCheckAllConfirm': '确定要对 {type} 的所有未禁用节点执行健康检测吗？\n\n检测到 429 时会标记为不健康并进入冷却。',
        'modal.provider.healthCheckAllIncludingDisabled': '检测全部(含禁用)',
        'modal.provider.healthCheckAllIncludingDisabledTitle': '检测所有账号，包括已禁用账号',
        'modal.provider.healthCheckAllIncludingDisabledConfirm': '确定要对 {type} 的所有节点执行健康检测吗？\n\n包含已禁用节点；检测到 429 时会标记为不健康并进入冷却。',
        'modal.provider.healthCheckAllRunning': '正在检测所有节点...',
        'modal.provider.healthCheckAll.complete': '全量健康检查完成: {success} 健康, {fail} 异常, {rateLimited} 个 429 冷却, {skipped} 跳过',
        'modal.provider.healthCheckAll.failed': '全量健康检查失败',
        'modal.provider.updateKiroNames': '更新名称',
        'modal.provider.updateKiroNamesTitle': '将当前 Kiro 节点名称更新为基于 RT 的稳定名称',
        'modal.provider.updateKiroNamesConfirm': '确定将 {type} 下所有可识别 RT 的节点名称更新为稳定名称吗？\n\n这会覆盖现有自定义名称。',
        'modal.provider.updateKiroNames.success': '名称更新完成：更新 {updatedCount}，跳过 {skippedCount}，失败 {errorCount}',
        'modal.provider.updateKiroNames.failed': '更新名称失败',
        'modal.provider.exportRtAll': '导出全部RT',
        'modal.provider.exportRtHealthy': '导出健康RT',
        'modal.provider.exportRtAllTitle': '导出所有 Kiro 账号的 refresh token',
        'modal.provider.exportRtHealthyTitle': '只导出健康且未禁用 Kiro 账号的 refresh token',
        'modal.provider.exportRt.success': '已导出 {count} 个 RT',
        'modal.provider.exportRt.noTokens': '没有可导出的 RT',
        'modal.provider.exportRt.failed': '导出 RT 失败',
        'modal.provider.kiroConsole.importRt': 'RT 导入',
        'modal.provider.kiroConsole.importAws': 'AWS 导入',
        'modal.provider.kiroConsole.importUnavailable': '导入功能尚未加载，请刷新页面后重试',
        'modal.provider.kiroConsole.noSelection': '请先选择账号',
        'modal.provider.kiroConsole.selected': '已选择 {count} 个账号',
        'modal.provider.kiroConsole.selectedHealthCheck': '检测选中',
        'modal.provider.kiroConsole.selectedResetHealth': '恢复选中',
        'modal.provider.kiroConsole.selectedRefreshUsage': '刷新选中用量',
        'modal.provider.kiroConsole.selectedEnable': '启用选中',
        'modal.provider.kiroConsole.selectedDisable': '禁用选中',
        'modal.provider.kiroConsole.selectedDelete': '删除选中',
        'modal.provider.kiroConsole.clearSelection': '清空选择',
        'modal.provider.kiroConsole.refreshUsage': '读取缓存用量',
        'modal.provider.kiroConsole.refreshUsageTitle': '只读取服务器已缓存的用量，不请求 Kiro 上游',
        'modal.provider.kiroConsole.forceRefreshUsage': '向上游刷新用量',
        'modal.provider.kiroConsole.forceRefreshUsageTitle': '向 Kiro 上游请求最新用量；可能触发上游限流',
        'modal.provider.kiroConsole.usage.notLoaded': '未刷新',
        'modal.provider.kiroConsole.usage.refreshing': '刷新中',
        'modal.provider.kiroConsole.usage.progress': '已完成 {completed}/{total}',
        'modal.provider.kiroConsole.usage.current': '正在刷新 {name}',
        'modal.provider.kiroConsole.usage.refreshDone': '用量刷新完成：{success} 成功，{fail} 失败',
        'modal.provider.kiroConsole.usage.missingResult': '服务端未返回该账号的用量结果',
        'modal.provider.kiroConsole.health.checking': '检测中',
        'modal.provider.kiroConsole.health.progress': '已检测 {completed}/{total}',
        'modal.provider.kiroConsole.health.current': '正在检测 {name}',
        'modal.provider.kiroConsole.health.noEnabled': '没有可检测的未禁用账号',
        'modal.provider.kiroConsole.health.noAccounts': '没有可检测的账号',
        'modal.provider.kiroConsole.health.noUnhealthy': '没有异常账号需要检测',
        'modal.provider.kiroConsole.recovery.countdown': '429恢复 {time}',
        'modal.provider.kiroConsole.recovery.checkingSoon': '等待恢复检测',
        'modal.provider.kiroConsole.selectedHealthCheckConfirm': '确定检测选中的 {count} 个 Kiro 账号吗？',
        'modal.provider.kiroConsole.selectedHealthChecking': '正在检测 {count} 个账号...',
        'modal.provider.kiroConsole.selectedHealthCheckDone': '检测完成：{success} 正常，{fail} 异常',
        'modal.provider.kiroConsole.selectedResetHealthConfirm': '确定将选中的 {count} 个账号恢复为正常状态吗？\n\n这会清空错误计数、错误信息和 429 冷却时间。',
        'modal.provider.kiroConsole.selectedResetHealthDone': '恢复完成：{success} 成功，{fail} 失败',
        'modal.provider.kiroConsole.selectedEnableConfirm': '确定启用选中的 {count} 个账号吗？',
        'modal.provider.kiroConsole.selectedDisableConfirm': '确定禁用选中的 {count} 个账号吗？',
        'modal.provider.kiroConsole.selectedStatusDone': '状态更新完成：{success} 成功，{fail} 失败',
        'modal.provider.kiroConsole.selectedDeleteConfirm': '确定删除选中的 {count} 个账号吗？此操作不可恢复。',
        'modal.provider.kiroConsole.selectedDeleteDone': '删除完成：{success} 成功，{fail} 失败',
        'modal.provider.kiroConsole.stats.total': '总账号',
        'modal.provider.kiroConsole.stats.healthy': '健康',
        'modal.provider.kiroConsole.stats.unhealthy': '异常',
        'modal.provider.kiroConsole.stats.disabled': '禁用',
        'modal.provider.kiroConsole.stats.proxied': '已绑定代理',
        'modal.provider.kiroConsole.stats.needsRefresh': '需刷新',
        'modal.provider.kiroConsole.columns.account': '账号',
        'modal.provider.kiroConsole.columns.status': '状态',
        'modal.provider.kiroConsole.columns.proxy': '代理',
        'modal.provider.kiroConsole.columns.usage': '用量',
        'modal.provider.kiroConsole.columns.activity': '活动',
        'modal.provider.kiroConsole.columns.actions': '操作',
        'modal.provider.kiroConsole.activity.requests': '请求数',
        'modal.provider.kiroConsole.activity.errors': '错误数',
        'modal.provider.kiroConsole.activity.lastUsed': '最后使用',
        'modal.provider.kiroConsole.activity.lastCheck': '最后检测',
        'modal.provider.time.justNow': '刚刚',
        'modal.provider.time.minutesAgo': '{count} 分钟前',
        'modal.provider.time.hoursAgo': '{count} 小时前',
        'modal.provider.time.daysAgo': '{count} 天前',
    ...
    'en-US': {
        ...
        'proxies.subtitle': 'Manage HTTP/SOCKS proxies and subscription-backed local proxy endpoints for provider nodes.',
        'proxies.total': 'Total Proxies',
        'proxies.poolEnabled': 'Pool Proxies',
        'proxies.assigned': 'Assigned Nodes',
        'proxies.subscriptionNodes': 'Subscription Nodes',
        'proxies.import': 'Batch Import',
        'proxies.importSubscription': 'Import Subscription',
        'proxies.add': 'Add Proxy',
        'proxies.edit': 'Edit Proxy',
        'proxies.search': 'Search name, address, tags...',
        'proxies.autoAssign': 'Auto-assign Unbound Nodes',
        'proxies.autoAssignTitle': 'Assign proxies to unbound nodes for this provider type',
        'proxies.singBox': 'Generate sing-box Config',
        'proxies.name': 'Name',
        ...
        'proxies.inPool': 'In Pool',
        'proxies.outPool': 'Out of Pool',
        'proxies.url': 'Proxy URL',
        'proxies.keyword': 'Filter Keyword',
        'proxies.startPort': 'Start Port',
        'proxies.importJsonFile': 'Import from JSON file',
        'proxies.importJsonHint': 'Supports sub2api exported JSON, A2 configs/proxies.json, or a plain proxy array. You can also paste JSON directly.',
        'proxies.importPlaceholder': 'One proxy per line: http://, https://, socks5://, host:port, host:port:user:pass. JSON paste is also supported.',
        'proxies.subscriptionPlaceholder': 'Paste a subscription URL, subscription content, or decoded node list. VLESS nodes become http://a2-proxy:port endpoints.',
        'proxies.emptyImport': 'Enter proxy content first',
        'proxies.importResult': 'Import complete: created {created}, reused {reused}, failed {failed}',
        'proxies.saved': 'Proxy saved',
        'proxies.deleted': 'Proxy deleted',
        'proxies.deleteConfirm': 'Delete this proxy? Bound nodes will be unbound.',
        'proxies.test': 'Test proxy',
        'proxies.testOk': 'Proxy is reachable',
        'proxies.testFailed': 'Proxy test failed',
        'proxies.autoAssignConfirm': 'Auto-assign proxies for all unbound {type} nodes?',
        'proxies.autoAssignResult': 'Auto-assign complete: assigned {assigned}, skipped {skipped}, no proxy {noProxy}',
        'modal.provider.proxy': 'Proxy',
        'modal.provider.noProxy': 'No node proxy',
        'modal.provider.autoAssignProxy': 'Auto-assign proxy',
        ...
        'oauth.kiro.batchImportInstructions': 'Enter refreshTokens one per line, or paste/import JSON. The system extracts every refreshToken field automatically.',
        ...
        'oauth.kiro.refreshTokensLabel': 'RefreshToken List or JSON',
        'oauth.kiro.refreshTokensPlaceholder': 'Enter one refreshToken per line, or paste any JSON. refreshToken fields are extracted automatically\nExample:\naorAxxxxxxxx\naorAyyyyyyyy',
        'oauth.kiro.importJsonFile': 'Import JSON File',
        'oauth.kiro.jsonParseError': 'Invalid JSON. Unable to extract refreshToken values',
        'oauth.kiro.fileReadError': 'Failed to read JSON file',
        ...
        'oauth.codex.tokensLabel': 'Token Data (JSON/Refresh Token)',
        'oauth.codex.tokensPlaceholder': 'Paste refresh_token-only JSON, full token JSON, or one refresh token per line...',
        'oauth.codex.importInstructions': 'Paste Codex refresh_token-only JSON or full token JSON. Supports a single object, object array, string array, or one refresh token per line.',
        ...
        'oauth.codex.jsonHint': 'Ensure JSON contains refresh_token, or both access_token and id_token',
        ...
        'config.advanced.rateLimitCooldownNote': 'When upstream returns 429, temporarily remove the current account from the pool, then recover it only after a successful post-cooldown check.',
        ...
        'config.proxy.proxiesFilePath': 'Proxy Pool File Path',
        'config.proxy.autoAssignOnImport': 'Auto-assign Proxy on Import',
        ...
        'modal.provider.actions.account': 'Account',
        'modal.provider.actions.proxyName': 'Proxy/Name',
        'modal.provider.actions.health': 'Health',
        'modal.provider.actions.exportCleanup': 'Export/Cleanup',
        'modal.provider.resetHealth': 'Reset Health',
        'modal.provider.resetHealthTitle': 'Restore all accounts to healthy state and clear error counters',
        'modal.provider.resetSingleHealthTitle': 'Restore this account to healthy state and clear error counters and cooldown time',
        'modal.provider.healthCheck': 'Check Unhealthy',
        'modal.provider.healthCheckAll': 'Check All',
        'modal.provider.healthCheckAllTitle': 'Check every enabled account; 429 responses are marked unhealthy with cooldown',
        'modal.provider.healthCheckAllConfirm': 'Run a health check for all enabled {type} nodes?\n\n429 responses will be marked unhealthy and put into cooldown.',
        'modal.provider.healthCheckAllIncludingDisabled': 'Check All + Disabled',
        'modal.provider.healthCheckAllIncludingDisabledTitle': 'Check every account, including disabled accounts',
        'modal.provider.healthCheckAllIncludingDisabledConfirm': 'Run a health check for every {type} node?\n\nDisabled nodes are included; 429 responses will be marked unhealthy and put into cooldown.',
        'modal.provider.healthCheckAllRunning': 'Checking all nodes...',
        'modal.provider.healthCheckAll.complete': 'Full health check complete: {success} healthy, {fail} abnormal, {rateLimited} rate-limited, {skipped} skipped',
        'modal.provider.healthCheckAll.failed': 'Full health check failed',
        'modal.provider.updateKiroNames': 'Update Names',
        'modal.provider.updateKiroNamesTitle': 'Update current Kiro node names to stable RT-based names',
        'modal.provider.updateKiroNamesConfirm': 'Update all {type} node names with recognizable RTs to stable names?\n\nThis will overwrite existing custom names.',
        'modal.provider.updateKiroNames.success': 'Name update complete: updated {updatedCount}, skipped {skippedCount}, failed {errorCount}',
        'modal.provider.updateKiroNames.failed': 'Failed to update names',
        'modal.provider.exportRtAll': 'Export All RT',
        'modal.provider.exportRtHealthy': 'Export Healthy RT',
        'modal.provider.exportRtAllTitle': 'Export refresh tokens for all Kiro accounts',
        'modal.provider.exportRtHealthyTitle': 'Export refresh tokens only for healthy, enabled Kiro accounts',
        'modal.provider.exportRt.success': 'Exported {count} RT(s)',
        'modal.provider.exportRt.noTokens': 'No RTs available to export',
        'modal.provider.exportRt.failed': 'Failed to export RT',
        'modal.provider.kiroConsole.importRt': 'Import RT',
        'modal.provider.kiroConsole.importAws': 'Import AWS',
        'modal.provider.kiroConsole.importUnavailable': 'Import UI is not loaded yet. Refresh and try again.',
        'modal.provider.kiroConsole.noSelection': 'Select accounts first',
        'modal.provider.kiroConsole.selected': '{count} account(s) selected',
        'modal.provider.kiroConsole.selectedHealthCheck': 'Check Selected',
        'modal.provider.kiroConsole.selectedResetHealth': 'Restore Selected',
        'modal.provider.kiroConsole.selectedRefreshUsage': 'Refresh Selected Usage',
        'modal.provider.kiroConsole.selectedEnable': 'Enable Selected',
        'modal.provider.kiroConsole.selectedDisable': 'Disable Selected',
        'modal.provider.kiroConsole.selectedDelete': 'Delete Selected',
        'modal.provider.kiroConsole.clearSelection': 'Clear Selection',
        'modal.provider.kiroConsole.refreshUsage': 'Load Cached Usage',
        'modal.provider.kiroConsole.refreshUsageTitle': 'Only reads cached usage on this server; does not request Kiro upstream',
        'modal.provider.kiroConsole.forceRefreshUsage': 'Refresh From Upstream',
        'modal.provider.kiroConsole.forceRefreshUsageTitle': 'Request fresh usage from Kiro upstream; this may trigger upstream rate limits',
        'modal.provider.kiroConsole.usage.notLoaded': 'Not refreshed',
        'modal.provider.kiroConsole.usage.refreshing': 'Refreshing',
        'modal.provider.kiroConsole.usage.progress': '{completed}/{total} complete',
        'modal.provider.kiroConsole.usage.current': 'Refreshing {name}',
        'modal.provider.kiroConsole.usage.refreshDone': 'Usage refresh complete: {success} succeeded, {fail} failed',
        'modal.provider.kiroConsole.usage.missingResult': 'The server did not return a usage result for this account',
        'modal.provider.kiroConsole.health.checking': 'Checking',
        'modal.provider.kiroConsole.health.progress': '{completed}/{total} checked',
        'modal.provider.kiroConsole.health.current': 'Checking {name}',
        'modal.provider.kiroConsole.health.noEnabled': 'No enabled accounts to check',
        'modal.provider.kiroConsole.health.noAccounts': 'No accounts to check',
        'modal.provider.kiroConsole.health.noUnhealthy': 'No abnormal accounts need checking',
        'modal.provider.kiroConsole.recovery.countdown': '429 recovery {time}',
        'modal.provider.kiroConsole.recovery.checkingSoon': 'Waiting recovery check',
        'modal.provider.kiroConsole.selectedHealthCheckConfirm': 'Run health check for {count} selected Kiro account(s)?',
        'modal.provider.kiroConsole.selectedHealthChecking': 'Checking {count} account(s)...',
        'modal.provider.kiroConsole.selectedHealthCheckDone': 'Health check complete: {success} healthy, {fail} abnormal',
        'modal.provider.kiroConsole.selectedResetHealthConfirm': 'Restore {count} selected account(s) to healthy state?\n\nThis clears error counters, error messages, and 429 cooldown time.',
        'modal.provider.kiroConsole.selectedResetHealthDone': 'Restore complete: {success} succeeded, {fail} failed',
        'modal.provider.kiroConsole.selectedEnableConfirm': 'Enable {count} selected account(s)?',
        'modal.provider.kiroConsole.selectedDisableConfirm': 'Disable {count} selected account(s)?',
        'modal.provider.kiroConsole.selectedStatusDone': 'Status update complete: {success} succeeded, {fail} failed',
        'modal.provider.kiroConsole.selectedDeleteConfirm': 'Delete {count} selected account(s)? This cannot be undone.',
        'modal.provider.kiroConsole.selectedDeleteDone': 'Delete complete: {success} succeeded, {fail} failed',
        'modal.provider.kiroConsole.stats.total': 'Total',
        'modal.provider.kiroConsole.stats.healthy': 'Healthy',
        'modal.provider.kiroConsole.stats.unhealthy': 'Abnormal',
        'modal.provider.kiroConsole.stats.disabled': 'Disabled',
        'modal.provider.kiroConsole.stats.proxied': 'Proxied',
        'modal.provider.kiroConsole.stats.needsRefresh': 'Needs Refresh',
        'modal.provider.kiroConsole.columns.account': 'Account',
        'modal.provider.kiroConsole.columns.status': 'Status',
        'modal.provider.kiroConsole.columns.proxy': 'Proxy',
        'modal.provider.kiroConsole.columns.usage': 'Usage',
        'modal.provider.kiroConsole.columns.activity': 'Activity',
        'modal.provider.kiroConsole.columns.actions': 'Actions',
        'modal.provider.kiroConsole.activity.requests': 'Requests',
        'modal.provider.kiroConsole.activity.errors': 'Errors',
        'modal.provider.kiroConsole.activity.lastUsed': 'Last Used',
        'modal.provider.kiroConsole.activity.lastCheck': 'Last Check',
        'modal.provider.time.justNow': 'just now',
        'modal.provider.time.minutesAgo': '{count}m ago',
        'modal.provider.time.hoursAgo': '{count}h ago',
        'modal.provider.time.daysAgo': '{count}d ago',
