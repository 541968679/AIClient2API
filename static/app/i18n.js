...
const translations = {
    'zh-CN': {
        ...
        'proxies.importPlaceholder': '每行一个代理，支持 http://、https://、socks5://、host:port、host:port:user:pass',
        ...
        'proxies.autoAssignConfirm': '确定为所有未绑定节点自动分配代理吗？',
    ...
    'en-US': {
        ...
        'proxies.importPlaceholder': 'One proxy per line: http://, https://, socks5://, host:port, host:port:user:pass',
        ...
        'proxies.autoAssignConfirm': 'Auto-assign proxies for all unbound nodes?',
